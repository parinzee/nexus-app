...
const entries = [
    {
        id: "3",
        text: "Instagram",
        icon: <MaterialCommunityIcons name="instagram" size={moderateScale(40)} color="#EB6383"/>,
    ...
    },
    {
        id: "1",
        text: "Nexus Website",
        icon: <MaterialCommunityIcons name="web" size={moderateScale(40)} color="#6886C5"/>,
        link: "https://www.nexusbcis.com",
    },
    {
        id: "2",
        text: "House Teams",
        icon: <MaterialCommunityIcons name="flag-variant" size={moderateScale(40)} color="#8F4068"/>,
...
export default function Contact() {
  ...
  return (
    <Container>
      <FlatList
        data={entries}
        renderItem={( {item} ) => (<Item text={item.text} icon={item.icon} link={item.link}/>)}
      />
    </Container>
  )
}
