  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={{color: "white", fontSize: 20}}>{this.state.currentPlayer === 1 ? "Your turn!" : "Ai Thinking"}</Text>
        ...
        <View style={{paddingTop: 50}} />
        <Button color="#01BAEF" title="New Game" onPress={this.onNewGamePress}/>
